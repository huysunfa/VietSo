...
{
	// Token: 0x060000EB RID: 235 RVA: 0x00007DC8 File Offset: 0x00005FC8
	public static void smethod_0(global::System.Exception exception_0)
	{
		global::System.Windows.Forms.MessageBox.Show(exception_0.Message, global::System.Windows.Forms.Application.CompanyName, global::System.Windows.Forms.MessageBoxButtons.OK, global::System.Windows.Forms.MessageBoxIcon.Hand);
	}

	// Token: 0x060000EC RID: 236 RVA: 0x00007DEC File Offset: 0x00005FEC
	public class PrDocument : global::PrintHelper.PrintBase
	{
		...
		public string NgachSo
		{
			get
			{
				if (string.IsNullOrWhiteSpace(this.string_3) && global::System.IO.File.Exists(global::DataModel.Util.getDataPath + "ngachso.ngs"))
				{
					global::System.Data.DataTable dataTable = global::DataText.Security.readFile<global::System.Data.DataTable>(global::DataModel.Util.getDataPath + "ngachso.ngs");
					...
					{
						this.string_3 = "";
						global::System.IO.File.Delete(global::DataModel.Util.getDataPath + "ngachso.ngs");
					}
				}
		...
		{
			global::DataText.LePhat.clearLongSo();
		}

		// Token: 0x17000027 RID: 39
		// (get) Token: 0x0600014D RID: 333 RVA: 0x00006E28 File Offset: 0x00005028
		public global::DataText.LongSoData LoaiSoData
		{
			get
			{
				return global::DataText.LePhat.getLongSo(this.string_4);
			}
		}
		...
		private decimal writeHeightAvalable
		{
			get
			{
				return this.LoaiSoData.PageHeight - (this.LoaiSoData.PagePaddingTop * 5m + this.LoaiSoData.PagePaddingBottom * 5m);
			}
		}
		...
		private decimal writeWidthAvalable
		{
			get
			{
				return this.LoaiSoData.PageWidth - (this.LoaiSoData.PagePaddingLeft * 5m + this.LoaiSoData.PagePaddingRight * 5m);
			}
		}
		...
		public override void Draw(global::System.Drawing.Graphics grp, bool isPrint = false)
		{
			...
			global::System.Collections.Generic.Dictionary<int, global::System.Collections.Generic.Dictionary<int, global::DataText.CellData>> dictionary_ = global::DataText.LePhat.longSoClone(this.LoaiSoData.LgSo);
			string string_ = "";
		...
		{
			if (!global::System.IO.File.Exists(global::DataModel.Util.getDataPath + "TinChuArea.txt"))
			{
				return false;
			}
			string text = global::System.IO.File.ReadAllText(global::DataModel.Util.getDataPath + "TinChuArea.txt");
		...
		private void method_3(ref global::System.Collections.Generic.Dictionary<int, global::System.Collections.Generic.Dictionary<int, global::DataText.CellData>> dictionary_0, ref float float_0, float float_1)
		{
			int num = 0;
			int num2 = 0;
		...
		private void method_4(ref global::System.Collections.Generic.Dictionary<int, global::System.Collections.Generic.Dictionary<int, global::DataText.CellData>> dictionary_0, int int_0)
		{
			if (int_0 < 0)
			{
				return;
			...
			foreach (global::System.Collections.Generic.KeyValuePair<int, global::System.Collections.Generic.Dictionary<int, global::DataText.CellData>> keyValuePair in dictionary_0)
			{
		...
		private float method_5(global::System.Drawing.Graphics graphics_0, global::System.Collections.Generic.Dictionary<int, global::System.Collections.Generic.Dictionary<int, global::DataText.CellData>> dictionary_0)
		{
			float num = 0f;
			foreach (global::System.Collections.Generic.KeyValuePair<int, global::System.Collections.Generic.Dictionary<int, global::DataText.CellData>> keyValuePair in dictionary_0)
			{
		...
		private void method_6(global::System.Drawing.Graphics graphics_0, global::System.Collections.Generic.Dictionary<int, global::System.Collections.Generic.Dictionary<int, global::DataText.CellData>> dictionary_0, float float_0, float float_1, float float_2, float float_3, bool bool_1, decimal decimal_0)
		{
			int num = 0;
			foreach (global::System.Collections.Generic.KeyValuePair<int, global::System.Collections.Generic.Dictionary<int, global::DataText.CellData>> keyValuePair in dictionary_0)
			{
				...
				float_0 -= float_3;
				float num2 = float_1;
				global::System.Collections.Generic.Dictionary<int, global::DataText.CellData> value = keyValuePair.Value;
				for (int i = 0; i < value.Count; i++)
				{
					int num3 = value.Keys.ElementAt(i);
					global::DataText.CellData cellData = value[num3];
		...
		private void method_7(global::System.Drawing.Graphics graphics_0, float float_0, float float_1, float float_2, float float_3, global::DataText.CellData cellData_0)
		{
		...
		private void method_8(global::DataText.CellData cellData_0, int int_0, int int_1, float float_0, float float_1, float float_2, float float_3)
		{
		...
		private void method_9(global::System.Collections.Generic.Dictionary<int, global::System.Collections.Generic.Dictionary<int, global::DataText.CellData>> dictionary_0, string string_5)
		{
			for (int i = 0; i < dictionary_0.Count; i++)
			{
				global::System.Collections.Generic.Dictionary<int, global::DataText.CellData> dictionary = dictionary_0[dictionary_0.Keys.ElementAt(i)];
				int j = 0;
				while (j < dictionary.Count)
				{
					int key = dictionary.Keys.ElementAt(j);
					global::DataText.CellData cellData = dictionary[key];
					...
					if (text.Contains("@"))
					{
						...
						IL_7F:
						global::System.Collections.Generic.Queue<global::DataText.CellData> queue = this.method_24(text2.ToLower(), string_5);
						int num = j;
						bool flag = false;
						while (queue.Count > 0)
						{
							global::DataText.CellData cellData2 = queue.Dequeue();
							global::DataText.CellData cellData3 = dictionary[dictionary.Keys.ElementAt(j)];
							...
							if (queue.Count > 0)
							{
										...
										for (int k = j; k < dictionary.Count; k++)
										{
											...
											if (string.IsNullOrEmpty(str2 + ((value4 != null) ? value4.ToString() : null)))
											{
												...
												while (j < num2)
												{
													...
													dictionary[dictionary.Keys.ElementAt(num2 - 1)] = new global::DataText.CellData();
													num2--;
												}
												goto IL_219;
											}
								...
								if (dictionary.Count == j)
								{
									...
									while (i + 1 < num3)
									{
										global::System.Collections.Generic.Dictionary<int, global::DataText.CellData> dictionary2 = dictionary_0[dictionary_0.Keys.ElementAt(num3)];
										global::System.Collections.Generic.Dictionary<int, global::DataText.CellData> dictionary3 = dictionary_0[dictionary_0.Keys.ElementAt(num3 - 1)];
										for (int m = 0; m < dictionary2.Count; m++)
										{
											dictionary2[dictionary2.Keys.ElementAt(m)] = dictionary3[dictionary3.Keys.ElementAt(m)];
											dictionary3[dictionary3.Keys.ElementAt(m)] = new global::DataText.CellData();
										}
										num3--;
									}
									j = num;
		...
		private bool method_10(global::System.Collections.Generic.Dictionary<int, global::DataText.CellData> dictionary_0)
		{
			using (global::System.Collections.Generic.Dictionary<int, global::DataText.CellData>.Enumerator enumerator = dictionary_0.GetEnumerator())
			{
				while (enumerator.MoveNext())
				{
					global::System.Collections.Generic.KeyValuePair<int, global::DataText.CellData> keyValuePair = enumerator.Current;
					global::DataText.CellData value = keyValuePair.Value;
		...
		private void method_11(global::System.Collections.Generic.Dictionary<int, global::System.Collections.Generic.Dictionary<int, global::DataText.CellData>> dictionary_0, ref string string_5)
		{
			string text = "";
			global::System.Collections.Generic.Queue<global::System.Collections.Generic.Queue<global::DataText.CellData>> tinChu = global::DataText.LePhat.getTinChu(this.PagodaID, base.Fml, ref text, ref string_5, this.IsNextYear);
			int num;
			int num2;
			this.method_14(dictionary_0, out num, out num2, "$Giachu");
			if (0 <= num && 0 <= num2)
			{
				global::DataText.CellData cellData = dictionary_0[num2][num];
			...
			int num3 = num;
			int num4 = num2;
			foreach (global::System.Collections.Generic.Queue<global::DataText.CellData> queue in tinChu)
			{
				foreach (global::DataText.CellData cellData2 in queue)
				{
		...
		private void method_12(global::System.Collections.Generic.Dictionary<int, global::System.Collections.Generic.Dictionary<int, global::DataText.CellData>> dictionary_0)
		{
			global::System.Collections.Generic.List<global::DataModel.Entities.Person> huongL = global::DataText.LePhat.getHuongL(this.PagodaID, base.Fml);
			if (huongL != null && huongL.Count > 0)
			{
				for (int i = 0; i < dictionary_0.Count; i++)
				{
					global::System.Collections.Generic.Dictionary<int, global::DataText.CellData> dictionary = dictionary_0[i];
					int j = 0;
					while (j < dictionary.Count)
					{
						global::DataText.CellData cellData = dictionary[j];
						object value = cellData.Value;
						if (value == null)
						{
							goto IL_59;
						...
						if (text.ToLower().Contains("$hlinhten".ToLower()))
						{
							int num = j;
							int num2 = i;
							foreach (global::DataModel.Entities.Person person in huongL)
							{
								foreach (global::DataText.CellData cellData2 in global::DataText.LePhat.convertToCell(global::DataText.LePhat.convert2Queue(person.FullName), "*huonglinh"))
								{
						...
						if (text3.ToLower().Contains("$hlinhsinh".ToLower()))
						{
							int num3 = j;
							int num4 = i;
							foreach (global::DataModel.Entities.Person person2 in huongL)
							{
								foreach (global::DataText.CellData cellData3 in global::DataText.LePhat.convertToCell(global::DataText.LePhat.convert2Queue(person2.Menh), "*hlinhsinh"))
								{
									if (num4 > 0 && dictionary_0.Count > num4)
									{
										if (dictionary_0[num4].Count <= num3)
						...
						if (text5.ToLower().Contains("$hlinhmat".ToLower()))
						{
							int num5 = j;
							int num6 = i;
							foreach (global::DataModel.Entities.Person person3 in huongL)
							{
								foreach (global::DataText.CellData cellData4 in global::DataText.LePhat.convertToCell(global::DataText.LePhat.convert2Queue(person3.DaiHanY), "*hlinhmat"))
								{
						...
						if (text7.ToLower().Contains("$hlinhtho".ToLower()))
						{
							int num7 = j;
							int num8 = i;
							foreach (global::DataModel.Entities.Person person4 in huongL)
							{
								foreach (global::DataText.CellData cellData5 in global::DataText.LePhat.convertToCell(global::DataText.LePhat.convert2Queue(global::DataText.LePhat.getChuNomYYYY(person4.HTho)), "*hlinhtho"))
								{
		...
		private void method_13(global::System.Collections.Generic.Dictionary<int, global::System.Collections.Generic.Dictionary<int, global::DataText.CellData>> dictionary_0)
		{
			int num;
			int num2;
			...
			if (!string.IsNullOrWhiteSpace(this.NgachSo))
			{
				...
				int num4 = num2;
				bool flag = true;
				foreach (string text in global::DataModel.Util.getPasteText(this.NgachSo))
				{
					if (num4 <= 0 || dictionary_0.Count <= num4)
					{
		...
		private void method_14(global::System.Collections.Generic.Dictionary<int, global::System.Collections.Generic.Dictionary<int, global::DataText.CellData>> dictionary_0, out int int_0, out int int_1, string string_5)
		{
			foreach (global::System.Collections.Generic.KeyValuePair<int, global::System.Collections.Generic.Dictionary<int, global::DataText.CellData>> keyValuePair in dictionary_0)
			{
				foreach (global::System.Collections.Generic.KeyValuePair<int, global::DataText.CellData> keyValuePair2 in keyValuePair.Value)
		...
		private void method_18(global::System.Drawing.Graphics graphics_0, float float_0, float float_1, float float_2, float float_3, global::DataText.CellData cellData_0)
		{
			if (cellData_0 == null)
			{
				return;
		...
		private void method_19(global::System.Drawing.Graphics graphics_0, float float_0, float float_1, float float_2, float float_3, global::DataText.CellData cellData_0)
		{
		...
		private global::System.Drawing.Font method_20(global::DataText.CellData cellData_0, bool bool_1)
		{
		...
		private void method_21(global::System.Drawing.Graphics graphics_0, float float_0, float float_1, float float_2, float float_3, global::DataText.CellData cellData_0)
		{
			if (cellData_0 == null)
			{
				return;
		...
		private global::System.Collections.Generic.Queue<global::DataText.CellData> method_24(string string_5, string string_6)
		{
			string text = "";
			global::System.Collections.Generic.Queue<global::DataText.CellData> queue = new global::System.Collections.Generic.Queue<global::DataText.CellData>();
			...
			foreach (string text2 in array)
			{
				...
				global::DataText.LePhat.getChuNho(ref queue, global::System.Globalization.CultureInfo.CurrentCulture.TextInfo.ToTitleCase(text2.ToLower()), value);
				if ("@nam".method_25(string_5) && flag)
				{
					flag = false;
					queue.Enqueue(new global::DataText.CellData());
					queue.Enqueue(new global::DataText.CellData());
					queue.Enqueue(new global::DataText.CellData());
				}
			}
		...
		public bool HasYear()
		{
			foreach (global::System.Collections.Generic.Dictionary<int, global::DataText.CellData> dictionary in this.LoaiSoData.LgSo.Values)
			{
				foreach (global::DataText.CellData cellData in dictionary.Values)
				{
					object value = cellData.Value;
					if (value == null)
					{
					...
					if (text.Contains("@"))
					{
						global::PrintHelper.PrDocument prDocument = "@nam";
						object value2 = cellData.Value;
						if (value2 == null)
						{
							goto IL_7A;
		...
		public global::DataModel.Year IsNextYear;

		// Token: 0x04000069 RID: 105
		private string string_4;

		// Token: 0x0400006A RID: 106
		public global::System.Collections.Generic.Dictionary<string, global::DataText.CellData> LongSoLocation = new global::System.Collections.Generic.Dictionary<string, global::DataText.CellData>();
