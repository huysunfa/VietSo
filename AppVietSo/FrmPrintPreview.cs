...
namespace AppVietSo
{
    public partial class FrmPrintPreview : Form
    {
        ...
        private void method_2()
        {
            ...
            {
                var KhoGiay = Util.InchToPixel(this.worksheet_0.PrintSettings.PaperWidth, 100f) - ShareFun.toPaperSize((decimal)Util.LongSoHienTai.PagePaddingRight) - ShareFun.toPaperSize((decimal)Util.LongSoHienTai.PagePaddingLeft);

                var Scaling = KhoGiay/hientai;
                this.worksheet_0.PrintSettings.PageScaling = (float)Scaling * (float) 0.96;
            }
            //else
            //{
