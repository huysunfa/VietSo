...
namespace AppVietSo
{
    partial class FrmThietLapHuongLinh
    {
        /// <summary>
    ...
    "otuoi  (Tuổi \'Số\')\r\n$sao  (Tên Sao)\r";
            ...
            this.groupBox2.Text = "Khuôn mẫu thể hiện 1 Hương Linh";
            // 
            // txtForm
            // 
            ...
            this.groupBox1.Text = "Thêm chữ sau phần Hương Linh";
            // 
            // txtMore
            // 
            ...
            this.Text = "Thiết lập phần Hương Linh";
            this.Load += new System.EventHandler(this.FrmThietLapHuongLinh_Load);
