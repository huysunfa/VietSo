...
namespace AppVietSo.Models
{
    ...
    public static global::System.Collections.Generic.List<Person> getList(string pagodaID, Family fml,bool PersonPerCol=false)
        ...
        public static int getNewSoNo(string pagodaID)
        {
            ...
            global::System.Collections.Generic.Dictionary<string, object> dictionary = new global::System.Collections.Generic.Dictionary<string, object>();
            dictionary.Add("@PagodaID", pagodaID);
            foreach (DataRow item in DbExecute.Select(query, dictionary).Rows)
            {
  
                    return BaseBO.GetInt(item["SoNo"]) + 1;
        ...
        public static Person get(string id)
        {
            ...
            foreach (DataRow dataRow in DbExecute.Select(query, dictionary).Rows)
            {
                ...
                return new Person
                {
                    ...
                    NgayMat = BaseBO.GetString(dataRow["NgayMat"]),
    ...
    {
        global::System.Collections.Generic.List<Person> list = PersonBO.getPersonObj(pagodaID, soNo);
        int i = 0;
        while (i < list.Count)
        {
            int num = i;
