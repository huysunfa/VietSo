...
namespace PrintSo
{
	...
	public partial class FrmDanhSach : Form
	{
		...
		private int row
		{
			get
			{
				if (Program.Stg.GetPrintSetting("TinChuH").Rows == 0)
				{
					...
					{
						Program.Stg.GetPrintSetting("TinChuH").Rows = 27;
					}
					else
					{
						Program.Stg.GetPrintSetting("TinChuH").Rows = 29;
					}
				}
		...
		private int col
		{
			get
			{
				if (Program.Stg.GetPrintSetting("TinChuH").Cols == 0)
				{
					if (this.curWS.PrintSettings.PaperName == "A4")
					{
						Program.Stg.GetPrintSetting("TinChuH").Cols = 16;
					}
					else if (this.curWS.PrintSettings.PaperName == "A3")
					{
						Program.Stg.GetPrintSetting("TinChuH").Cols = 18;
					}
					else
					{
						Program.Stg.GetPrintSetting("TinChuH").Cols = 16;
		...
		private void btnTinChu_Click(object sender, EventArgs e)
		{
			try
			{
				FrmPerson frmPerson = new FrmPerson(true, "");
		...
		private void PageSetting()
		{
			...
			{
				pageSettings.Margins = new PageMargins(Program.Stg.GetPrintSetting("TinChuH").MarginT, Program.Stg.GetPrintSetting("TinChuH").MarginB, Program.Stg.GetPrintSetting("TinChuH").MarginL, Program.Stg.GetPrintSetting("TinChuH").MarginR);
			}
		...
		private void btnKhuonTinChu_Click(object sender, EventArgs e)
		{
			try
			{
				if (new FrmThietLapTinChu(this.tlTC).ShowDialog(this) == DialogResult.OK)
				{
					this.FillTinChu();
				}
			}
